...
detailForm.addEventListener("submit", (event) => {
    ...
    const finalResume = `
        ...
        <p class="final-resume-head"><b>Name:</b> ${userName}</p>
        <p class="final-resume-head"><b>Email:</b> ${email}</p>
        <p class="final-resume-head"><b>Contact No:</b> ${number}</p>
        <p class="final-resume-head"><b>Education:</b> ${education}</p>
        <p class="final-resume-head"><b>Skills:</b> ${skills}</p>
        <p class="final-resume-head"><b>Experience:</b> ${experience}</p>
        <p class="final-resume-head"><b>About:</b> ${about}</p>
    `;
